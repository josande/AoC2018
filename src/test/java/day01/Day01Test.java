...
import static day01.Day01.getFirstRepeatedFrequency;
import static day01.Day01.getFrequenciesFromString;
import static day01.Day01.getFrequency;
...
class Day01Test {
    ...
    void exampleOne() {
        ...
        assertEquals(3,getFrequency(input));
    }
    ...
    void exampleThree() {
        String input = "+1, +1, -2";
        assertEquals(0,getFrequency(input));
    }

    @Test
    void exampleFour() {
        String input = "-1, -2, -3";
        assertEquals(-6,getFrequency(input));
    }
